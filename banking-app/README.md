...
This project is intentionally kept simple enough for a fresher project and interview explanation, while still including production-style config for deployment.
